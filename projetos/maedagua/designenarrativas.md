...
- Disponibilizar o pack de assets abertos, como: paleta de cores, fonte, logotipo, patterns, e uma proposta de badges que vão funcionar como [tokens](https://pt.wikipedia.org/wiki/Token_(chave_eletr%C3%B4nica)) de enredamento para classificar cada release de desenvolvimento a ser lançado. Esses itens serão manualizados e o guide de uso também será publicado;
